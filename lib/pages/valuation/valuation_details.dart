                ...
                SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ViewTile(
                        title: Valuation.LAND_BOUNDARIES_DEMARKATION,
                        value: widget.valuation.landBoundariesDemarkation,
                        icon: Icons.shape_line_outlined,
                        onPressed: onEditAction,
                        tabIndex: 1,
                      ),
                      ViewTile(
                        title: Valuation.TOPOGRAPHY_OF_LAND,
                        value: widget.valuation.topographyOfLand,
                        icon: Icons.format_shapes_sharp,
                        onPressed: onEditAction,
                        tabIndex: 1,
                      ),
                      ViewTile(
                        title: Valuation.ADJACENT_PLOT_LEVELS,
                        value: widget.valuation.adjacentPlotLevels,
